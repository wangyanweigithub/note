...
* [0. 前言 68](#0-前言-68)
	* [0.1 C++另类简介：比你用的复杂，但比你想的简单 69](#01-c另类简介比你用的复杂但比你想的简单-69)
	* [0.2 适宜读者群 87](#02-适宜读者群-87)
	* [0.3 版权 99](#03-版权-99)
	* [0.4 推荐编译环境 105](#04-推荐编译环境-105)
	* [0.5 体例 121](#05-体例-121)
		* [0.5.1 示例代码 123](#051-示例代码-123)
		* [0.5.2 引用 131](#052-引用-131)
	* [0.6 意见、建议、喷、补遗、写作计划 142](#06-意见建议喷补遗写作计划-142)
* [1. Template的基本语法 155](#1-template的基本语法-155)
	* [1.1 Template Class基本语法 157](#11-template-class基本语法-157)
		* [1.1.1 Template Class的与成员变量定义 159](#111-template-class的与成员变量定义-159)
		* [1.1.2 模板的使用 196](#112-模板的使用-196)
		* [1.1.3 模板类的成员函数定义 256](#113-模板类的成员函数定义-256)
	* [1.2 Template Function的基本语法 319](#12-template-function的基本语法-319)
		* [1.2.1 Template Function的声明和定义 321](#121-template-function的声明和定义-321)
		* [1.2.2 模板函数的使用 385](#122-模板函数的使用-385)
	* [1.3 整型也可是Template参数 532](#13-整型也可是template参数-532)
	* [1.4 模板形式与功能是统一的 612](#14-模板形式与功能是统一的-612)
* [2.  模板元编程基础 618](#2--模板元编程基础-618)
	* [2.1 编程，元编程，模板元编程 619](#21-编程元编程模板元编程-619)
	* [2.2 模板世界的If-Then-Else：类模板的特化与偏特化 766](#22-模板世界的if-then-else类模板的特化与偏特化-766)
		* [2.2.1 根据类型执行代码 768](#221-根据类型执行代码-768)
		* [2.2.2 特化 873](#222-特化-873)
		* [2.2.3 特化：一些其它问题 1092](#223-特化一些其它问题-1092)
	* [2.3 即用即推导 1355](#23-即用即推导-1355)
		* [2.3.1 视若无睹的语法错误 1357](#231-视若无睹的语法错误-1357)
		* [2.3.2 名称查找：I am who I am 1393](#232-名称查找i-am-who-i-am-1393)
		* [2.3.3 “多余的”  typename 关键字 1655](#233-多余的--typename-关键字-1655)
	* [2.4 本章小结 1746](#24-本章小结-1746)
* [3   深入理解特化与偏特化 1758](#3---深入理解特化与偏特化-1758)
	* [3.1 正确的理解偏特化 1760](#31-正确的理解偏特化-1760)
		* [3.1.1 偏特化与函数重载的比较 1762](#311-偏特化与函数重载的比较-1762)
		* [3.1.2 不定长的模板参数 1916](#312-不定长的模板参数-1916)
		* [3.1.3 模板的默认实参 2035](#313-模板的默认实参-2035)
	* [3.2 后悔药：SFINAE 2182](#32-后悔药sfinae-2182)

<!-- vim-markdown-toc -->

## 0. 前言 68
### 0.1 C++另类简介：比你用的复杂，但比你想的简单 69
...
### 1.1 Template Class基本语法 157

#### 1.1.1 Template Class的与成员变量定义 159
...
### 1.2 Template Function的基本语法 319

#### 1.2.1 Template Function的声明和定义 321
...
### 2.2 模板世界的If-Then-Else：类模板的特化与偏特化 766
...
``` C++
#define BIN_OP(type, a, op, b, result) (*(type *)(result)) = (*(type const *)(a)) op (*(type const*)(b)) 802
...
```C++
#include <complex> 2087
#include <type_traits> 2088
...
```cpp
#include <complex> 2128
#include <type_traits> 2129
...
```C++
#include <type_traits> 2526
#include <utility> 2527
#include <cstdint> 2528
